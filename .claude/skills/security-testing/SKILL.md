...
Upstream this skill cross-referenced `agentic-quality-engineering`, `api-testing-patterns`
and `compliance-testing`. **None of the three was imported into this repo**, so the links
were removed rather than left dangling. In this repo the adjacent skills are:

- [rbac-qa](../rbac-qa/SKILL.md) — access-control and UI quality gate for the dashboard
- [webapp-testing](../webapp-testing/SKILL.md) — Playwright-driven frontend verification
