...
> Orchestrator: `scripts/pipeline/run_ssot_pipeline.py` (Contract: CTR-PIPELINE-RUNNER-001)
> Created: 2026-02-12
...
python scripts/pipeline/run_ssot_pipeline.py --stage all --seed 42

# Multi-seed (5 seeds, selects best by eval reward)
python scripts/pipeline/run_ssot_pipeline.py --stage all --multi-seed

# Individual stages
python scripts/pipeline/run_ssot_pipeline.py --stage l2
python scripts/pipeline/run_ssot_pipeline.py --stage l3 --seed 42
python scripts/pipeline/run_ssot_pipeline.py --stage l4
python scripts/pipeline/run_ssot_pipeline.py --stage l4-val   # Validation only (gate)
python scripts/pipeline/run_ssot_pipeline.py --stage l4-test   # Test only (final OOS)

# Specific experiment config
python scripts/pipeline/run_ssot_pipeline.py --config config/experiments/exp_asym_001.yaml --multi-seed
```
...
**Files**:
- Orchestrator: `scripts/pipeline/run_ssot_pipeline.py` → `run_l3_training()`
- Multi-seed: `scripts/pipeline/run_ssot_pipeline.py` → `run_l3_multi_seed()`
...
**File**: `scripts/pipeline/run_ssot_pipeline.py` → `run_l4_backtest()`, `run_l4_validation()`
...
store (`s3://mlflow`). Ad-hoc training scripts (e.g., `scripts/pipeline/run_ssot_pipeline.py`) already log
