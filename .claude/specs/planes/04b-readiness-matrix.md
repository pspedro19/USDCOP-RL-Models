...
| RISK-06 | Risk | API e identidad del motor de métricas | Constructor, catálogo, annualización e identidad permanecen alineados y los consumidores instancian el contrato vigente | [BL-18](backlog/BL-18-catalogo-motor-metricas.md) tiene productor `persist_governed_metric_events` y consumidor de `control.metric_event`, pero sigue PARTIAL por cobertura no generalizada, allowlist heredado y decisión pendiente sobre colisión semántica; la [prueba de seguridad](../../../tests/unit/test_codex_safety_contracts.py) usa el registro gobernado | PARTIAL | CODEX / BL-18 | 2026-08-06 |
...
- Batería factual amplia del corte original: `199 passed, 3 failed, 1 skipped`; sumada al gate
  ...
  el 2026-08-06. `RISK-06` permanece `PARTIAL` por cobertura todavía no generalizada, el allowlist y
  la decisión de colisión semántica de BL-18, no por falta absoluta de llamadores ni por aquel argumento retirado. El fallo
