#!/usr/bin/env python3
"""
USDCOP Trading Models API (Canonical)
=====================================

**Canonical multi-model trading API for USDCOP-RL-Models project.**

This is the official, production-ready FastAPI service for multi-model
trading operations. Consolidates previous implementations into a single
async-first API.

Replaces: multi_model_trading_api.py (archived to archive/services-deprecated/)
