...
- **Industry-level performance**: Note specific industries showing strength or weakness within sectors
...
Think in English while analyzing the charts. Document specific numerical performance figures for key sectors and industries. Charts typically show performance over 1-week and 1-month periods; user-provided charts may vary in format but should contain similar relative performance information.
