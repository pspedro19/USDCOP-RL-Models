...
# ============================================================================
# GLOBAL HANDLERS - For direct import
# ============================================================================

# Create global handler instances for common imports
SCIPY_HANDLER = get_scipy_handler()
GYMNASIUM_HANDLER = get_gymnasium_handler()
TORCH_HANDLER = get_torch_handler()
STABLE_BASELINES3_HANDLER = get_stable_baselines3_handler()
SKLEARN_HANDLER = get_sklearn_handler()