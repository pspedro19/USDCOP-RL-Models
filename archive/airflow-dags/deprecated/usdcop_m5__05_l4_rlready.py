...
# UPDATED FOR FASE 2: Expanded from 17 to 32 features
# Total: 14 (Tier 1+2) + 3 (hour/spread) + 7 (macro) + 8 (MTF) = 32 features
FEATURE_MAP = {
    ...
    # FASE 2: Tier 3 - Macro features (7 features)
    'obs_17': 'wti_return_5',
    ...
    # FASE 2: Tier 4 - Multi-Timeframe features (8 features)
    # 15min timeframe (5 features)
    'obs_24': 'sma_20_15m',
    'obs_25': 'ema_12_15m',
    'obs_26': 'rsi_14_15m',
    'obs_27': 'macd_15m',
    'obs_28': 'trend_15m',  # DIRECTIONAL: {-1, 0, +1}
...
def load_l3_data(**context) -> Dict[str, Any]:
    ...
    prefix = "rl-features/usdcop_m5__04_l3_feature"  # RL features subfolder
