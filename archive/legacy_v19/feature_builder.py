...
DEPRECATED: This is legacy V19 code. Use feature_store instead:
    from feature_store import UnifiedFeatureBuilder, get_feature_builder

This file is maintained for backward compatibility with V19 models only.
For new development, use the unified feature_store module.

Migration:
    # Old way (V19)
    from features.feature_builder import FeatureBuilderV19
...
Date: 2025-12-26
Status: DEPRECATED - Use feature_store instead
"""
