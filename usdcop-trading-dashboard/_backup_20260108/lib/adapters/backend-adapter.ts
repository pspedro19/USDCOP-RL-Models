 ...
 * NOTA: Actualmente solo RL está activo (ppo_v1). Los demás son placeholders para futuro.
 */
export const STRATEGY_TO_MODEL: Record<string, string> = {
  RL_PPO: 'ppo_v1',  // Producción actual
  RL_SAC: 'sac_v1',  // Placeholder
  RL_TD3: 'td3_v1',  // Placeholder
  RL_A2C: 'a2c_v1',  // Placeholder
  ML_XGB: 'xgb_v1',  // Placeholder
  ML_LGBM: 'lgbm_v1', // Placeholder
};
...
export const MODEL_TO_STRATEGY: Record<string, string> = {
  ppo_v1: 'RL_PPO',  // Producción actual
  sac_v1: 'RL_SAC',
  td3_v1: 'RL_TD3',
  a2c_v1: 'RL_A2C',
  xgb_v1: 'ML_XGB',
