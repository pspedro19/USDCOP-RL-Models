...
import NotificationItem from './alert-notification';
import type { Notification } from './alert-notification';
...
export const NotificationProvider = ({
  ...
  useEffect(() => {
    ...
    const unsubscribeSignals = wsManager.on('signals', handleSignal);
    const unsubscribeTrades = wsManager.on('trades', handleTrade);
    wsManager.connect();
