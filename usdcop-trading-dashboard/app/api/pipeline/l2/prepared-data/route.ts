  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json({
        success: false,
        error: 'L2 PIPELINE NOT EXECUTED',
        message: 'No data available in MinIO bucket: 02-l2-ds-usdcop-prepare',
        instructions: 'Execute DAG in Airflow: usdcop_m5__03_l2_prepare',
        pipeline: 'L2',
