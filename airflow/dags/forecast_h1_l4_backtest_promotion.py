...
The H1 pipeline currently uses scripts/pipeline/generate_weekly_forecasts.py for training
...
For now, use the manual workflow:
    python scripts/pipeline/generate_weekly_forecasts.py       # Train + export to /forecasting
...
def placeholder_task(**context) -> None:
    ...
    Use scripts/pipeline/generate_weekly_forecasts.py manually.
    """
    logger.info("=" * 60)
    logger.info("[H1-L4] PLACEHOLDER — H1 backtest promotion not yet implemented")
    logger.info("[H1-L4] Manual workflow:")
    logger.info("[H1-L4]   1. python scripts/pipeline/generate_weekly_forecasts.py")
