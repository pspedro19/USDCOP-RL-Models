...
Tests full integration of components:
- ObservationBuilder
- StateTracker
- RiskManager
- PaperTrader
...
class TestComponents:
    """Test all components exist and have expected interface."""

    def test_observation_builder_exists(self):
        """Test ObservationBuilder instantiation and OBS_DIM."""
...
class TestObservationBuilder:
    """Detailed tests for ObservationBuilder."""
    ...
    def test_feature_order_is_correct(self, builder):
        """Test feature order matches specification."""
        expected = [
