"""
ObservationBuilderV19 - Observation Builder for V19 Trading System
===================================================================

Implements the observation vector construction for the V19 model with:
...
Configuration:
    - Feature config: config/feature_config_v19.json
    - Normalization stats: config/v19_norm_stats.json
"""
...
DEFAULT_CONFIG_PATH = "config/feature_config_v19.json"
DEFAULT_STATS_PATH = "config/v19_norm_stats.json"


class ObservationBuilderV19:
    """
    Observation builder for V19 USDCOP trading model.
    ...
    def __init__(
        ...
        """
        Initialize the ObservationBuilderV19.
    ...
    def _validate_config(self) -> None:
        """
        Validate that configuration matches expected V19 format.
    ...
    def build(
        ...
        Note:
            ...
            - Features are normalized using z-score from v19_norm_stats.json
        """
    ...
    def __repr__(self) -> str:
        return (
            f"ObservationBuilderV19(obs_dim={self.OBS_DIM}, "
...
def create_observation_builder_v19(
    config_path: str = DEFAULT_CONFIG_PATH,
    base_path: Optional[str] = None
) -> ObservationBuilderV19:
    """
    Factory function to create an ObservationBuilderV19 instance.
    ...
    Returns:
        Configured ObservationBuilderV19 instance
    """
    return ObservationBuilderV19(config_path=config_path, base_path=base_path)
