"""
ZScoreNormalizer V19 - Z-Score Normalization with Config Loading
=================================================================

Enhanced z-score normalizer that loads statistics from configuration files
and provides normalization/denormalization for the V19 trading system.
...
class ZScoreNormalizerV19:
    """
    Z-Score normalizer that loads statistics from V19 configuration.
    ...
    Example:
        >>> normalizer = ZScoreNormalizerV19()
    ...
    def __init__(
        ...
        """
        Initialize the ZScoreNormalizerV19.
    ...
    def __repr__(self) -> str:
        return (
            f"ZScoreNormalizerV19(n_features={len(self._stats)}, "
            f"clip={self._clip_values})"
        )


# Backward-compatible alias
ZScoreNormalizer = ZScoreNormalizerV19


# Factory function
def create_zscore_normalizer_v19(
    stats_path: str = DEFAULT_STATS_PATH,
    base_path: Optional[str] = None
) -> ZScoreNormalizerV19:
    """
    Factory function to create a ZScoreNormalizerV19 instance.
    ...
    Returns:
        Configured ZScoreNormalizerV19 instance
    """
    return ZScoreNormalizerV19(stats_path=stats_path, base_path=base_path)
