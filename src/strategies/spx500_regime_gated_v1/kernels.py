...
if __package__:
    ...
    from .economic_metrics import PERIODS_PER_YEAR, cer, cer_gain_bps, sharpe
    from .gates import REQUIRED_BENCHMARKS, gate_g4, gate_g6, validate_report_benchmarks
    from .pbo import cscv
