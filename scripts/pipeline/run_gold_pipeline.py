...
Usage:
    python scripts/pipeline/run_gold_pipeline.py                 # backtest + publish all strategies
    python scripts/pipeline/run_gold_pipeline.py --no-publish    # science only, print metrics
    python scripts/pipeline/run_gold_pipeline.py --warmup 300 --year 2026
"""
...
REPO = Path(__file__).resolve().parents[2]  # scripts/pipeline/<this> -> repo root (reorg fix)
